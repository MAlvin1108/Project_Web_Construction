...
import { portofolioData } from '../mock';

export const Portofolio = () => {
    const [filter, setFilter] = useState('All');

    const categories = ['All', 'Residental', 'Commercial', 'Cultural'];

    const filteredProjects = filter === 'All'
    ? portofolioData.filteredProjects
    : portofolioData.projects.filter(project => project.categories === filter);
